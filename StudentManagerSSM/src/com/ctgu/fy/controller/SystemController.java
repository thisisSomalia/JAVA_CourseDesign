...
@RequestMapping("/system")   //类里面子方法都是跟在url中system后面，没有则在根目录下，但是容易乱套
@Controller
public class SystemController {
	...
	@RequestMapping(value = "/index",method=RequestMethod.GET) //方法的注释表示路径，但要跟在system后面
	public ModelAndView index(ModelAndView model){
		model.setViewName("system/index"); //model加上springmvc里面设置的视图解析器去找
		return model;
	}
