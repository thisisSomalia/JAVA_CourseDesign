			...
			$.ajax({
				...
				success: function(data){
					if("success" == data.type){
						window.parent.location.href = "index";//跳转
					} else{
...
<div class="header" style="padding: 0; background-color: rgba(0,0,0,0);">
	<h2 style="color: green; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">学生信息管理系统</h2>
</div> 
...
<div class="footer" style="padding: 0; background-color: rgba(0,0,0,0);text-align: center;">
	<div style="color:red;">Copyright 2019 &nbsp; By Feng Yang</div>
</div> 

<!-- <div class="footer" >
	<p sytle="background-color: rgba(0,0,0,0);"> Copyright 2019 &nbsp; By Feng Yang </p>
</div> -->
